                    ...
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col col-xs-6 text-right">
                                <a href="#"><button type="button" class="btn btn-sm btn-primary btn-create"
                                        data-toggle="modal" data-target="#myModal"><i class="fas fa-plus-square"></i>
                                        Tambah
                                        Data</button></a>
                            </div>
                        </div>
                                ...
                                <tr>
                                    <td align="center">
                                        <a class="btn btn-warning">
                                            <span class="actionCust"> <i class="fas fa-pencil-alt" data-toggle="modal"
                                                    data-target="#edit<?=$idm;?>"></i></span>
                                        </a>
                                        <a class="btn btn-danger"> <span class="actionCust"><i class="fas fa-trash"
                                                    data-toggle="modal" data-target="#delete<?=$idm;?>"></i></span></a>
                                    </td>
                                    <td><?=$i++;?></td>
                                    <td><?=$namabarang;?></td>
                                    <td><?=$jenis;?></td>
